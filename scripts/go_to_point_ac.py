...
# \file go_to_point_ac.py
# \brief this file is an implementation of go to point action server node
# \author Carmine Recchiuto - Yara Abdelmottaleb
# \version 0.1
# \date 20/09/2021
#
# \details
...
##
# \brief this is the callback function of /odom subscriber
# \param msg the current odometry of the robot received through the topic /odom. 
#
#
...
##
# \brief this is change_state function of the robot
# \param state the current state value of the robot (0, 1, 2)
#
#
...
##
# \brief this function normalizes the angle to be in the range from -pi to pi
# \param angle the requested angle to be normalized
#
...
##
# \brief this function is responsible for orienting the robot's yaw angle towards the goal point
# \param des_pos the desired position of the goal
#
...
##
# \brief this function is responsible for driving the robot straight towards a goal position
# \param des_pos the desired goal position
#
...
##
# \brief this function is responsible for orienting the robot's yaw angle in the final goal orientation
# \param des_yaw the desired yaw angle of the goal
#
...
##
# \brief this function is responsible for stopping the robot
#
...
##
# \brief this is the callback function of /go_to_point_ac action service
# \param goal the requested goal position
#
# \return always true
#
